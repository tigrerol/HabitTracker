...
private struct DayTypePresetsView: View {
    ...
    private static func createStandardWeek() -> DayCategorySettings {
        ...
        settings.setCategories(Set(["weekday"]), for: .wednesday)
        settings.setCategories(Set(["weekday"]), for: .thursday)
        settings.setCategories(Set(["weekday"]), for: .friday)
    ...
    private static func createSundayWorkWeek() -> DayCategorySettings {
        var settings = DayCategorySettings()
        settings.setCategories(Set(["weekday"]), for: .sunday)
        settings.setCategories(Set(["weekday"]), for: .monday)
        settings.setCategories(Set(["weekday"]), for: .tuesday)
        settings.setCategories(Set(["weekday"]), for: .wednesday)
        settings.setCategories(Set(["weekday"]), for: .thursday)
        settings.setCategories(Set(["weekend"]), for: .friday)
        settings.setCategories(Set(["weekend"]), for: .saturday)
        return settings
    }
    ...
    private static func createShiftWorkerA() -> DayCategorySettings {
        ...
        settings.setCategories(Set(["weekday"]), for: .tuesday)
        settings.setCategories(Set(["weekday"]), for: .wednesday)
        settings.setCategories(Set(["weekend"]), for: .thursday)
        settings.setCategories(Set(["weekend"]), for: .friday)
        settings.setCategories(Set(["weekend"]), for: .saturday)
        settings.setCategories(Set(["weekend"]), for: .sunday)
        return settings
    ...
    private static func createShiftWorkerB() -> DayCategorySettings {
        var settings = DayCategorySettings()
        settings.setCategories(Set(["weekend"]), for: .monday)
        settings.setCategories(Set(["weekend"]), for: .tuesday)
        settings.setCategories(Set(["weekend"]), for: .wednesday)
        settings.setCategories(Set(["weekday"]), for: .thursday)
        settings.setCategories(Set(["weekday"]), for: .friday)
        settings.setCategories(Set(["weekday"]), for: .saturday)
        settings.setCategories(Set(["weekday"]), for: .sunday)
        return settings
    }
    ...
    private static func createAllWeekdays() -> DayCategorySettings {
        var settings = DayCategorySettings()
        for weekday in Weekday.allCases {
            settings.setCategories(Set(["weekday"]), for: weekday)
        }
        return settings
    }
    ...
    private static func createAllWeekends() -> DayCategorySettings {
        var settings = DayCategorySettings()
        for weekday in Weekday.allCases {
            settings.setCategories(Set(["weekend"]), for: weekday)
        }
        return settings
    }
}
